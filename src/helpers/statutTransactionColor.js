import IDS_TRANSACTION_STATUS from "../constants/IDS_TRANSACTION_STATUS.js"

export default function statutTransactionColor(idStatut) {
          const defaultColor = {
          ...
          const COLORS = {
                    ...
                    [ IDS_TRANSACTION_STATUS.APPROUVEE]: {
                    ...
                    [IDS_TRANSACTION_STATUS.REJECTEE]: {
                    ...
                    [IDS_TRANSACTION_STATUS.EN_ETTENTE]: {
