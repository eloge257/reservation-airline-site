...
export default function EditFournisseurPage({ setElementEdit,elementEdit,visibleModal, setVisibleModal, fetchSalle }) {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (isValidate()) {
       ...
       await fetchApi(`/api/fournisseur/${elementEdit?.id}`, {
          method: "PUT",
          body: form,
        });
        dispacth(
