...
import AddFournisseurPage from "./AddFournisseurPage";
import EditFournisseurPage from "./EditFournisseurPage";
...
export default function ListFournisseurPage() {
    ...
    const fetchSalle = useCallback(async () => {
        try {
                     ...
                     setLoading(true);
            let url = `${API_URL.LOCAL_URL}/api/fournisseur?`;
    ...
    return (
        <>
            ...
            <AddFournisseurPage setVisible={setVisible} visible={visible} fetchSalle={fetchSalle} />
            {/* ********modal pour editer un elemnt ******** */}
            <EditFournisseurPage setElementEdit={setElementEdit} elementEdit={elementEdit} setVisibleModal={setVisibleModal} visibleModal={visibleModal} fetchSalle={fetchSalle} />
        </>
    );
}