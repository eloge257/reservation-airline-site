...
export default function DetailAchatPage() {
    ...
    const fetchSalle = useCallback(async () => {
        try {
            ...
            setLoading(true);
            const response = await axios.get(`${API_URL.LOCAL_URL}/api/findAllAchatBy_suppliedId`);
    ...
    const exportData = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/api/findAllAchatBy_suppliedId`;
                    ...
                    <div className="rounded mt-3 pr-1 bg-white">
                        ...
                        >
                            <Column
                                ...
                                header='Produit'
                                sortable
                                body={(item) => (item ? item.name_p : "-")}
                            />
                            <Column
                                field="Quantite"
                                header='Quantite'
                                sortable
                                body={(item) => (item ? item.quantity_q : "-")}
                            />
