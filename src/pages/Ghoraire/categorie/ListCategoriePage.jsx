...
import AddCategoriePage from "./AddCategoriePage";
...
export default function ListCategoriePage() {
    ...
    const deleteItems = async (itemsIds) => {
        try {
          ...
          const response =  await axios.delete(`${API_URL.LOCAL_URL}/api/categorie/${itemsIds}`);
    ...
    const fetchSalle = useCallback(async () => {
        try {
            // setLoading(true);
            // const response = await axios.get(`${API_URL.LOCAL_URL}/api/categorie`);
            // setSalle(response.data.result)
            // setTotalRecords(response.data.result.length)

            setLoading(true);
            let url = `${API_URL.LOCAL_URL}/api/categorie?`;
    ...
    return (
        <>
            ...
            <AddCategoriePage setVisible={setVisible} visible={visible} fetchSalle={fetchSalle} />
            <EditCategoriePage setElementEdit={setElementEdit} elementEdit={elementEdit} setVisibleModal={setVisibleModal} visibleModal={visibleModal} fetchSalle={fetchSalle} />
