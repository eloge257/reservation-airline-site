...
export default function EditCompanyPage({ elementEdit, visibleModal, setVisibleModal, fetchSalle }) {
    ...
    useEffect(() => {
        setData({
            ...
            obr_username: elementEdit?.obr_username || "",
            obr_password: elementEdit?.obr_password || "",
            tp_type: elementEdit?.tp_type || "",
            tp_TIN: elementEdit?.tp_TIN || "",
            tp_trade_number: elementEdit?.tp_trade_number || "",
            tp_postal_number: elementEdit?.tp_postal_number || "",
            tp_phone_number: elementEdit?.tp_phone_number || "",
            tp_address_province: elementEdit?.tp_address_province || "",
            tp_address_commune: elementEdit?.tp_address_commune || "",
            tp_address_quartier: elementEdit?.tp_address_quartier || "",
            tp_address_avenue: elementEdit?.tp_address_avenue || "",
            tp_address_rue: elementEdit?.tp_address_rue || "",
            tp_address_number: elementEdit?.tp_address_number || "",
            tp_activity_sector: elementEdit?.tp_activity_sector || "",
            tp_fiscal_center: elementEdit?.tp_fiscal_center || "",
            tp_legal_form: elementEdit?.tp_legal_form || "",
        })
    }, [elementEdit])
    const {
        hasError,
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            if (isValidate()) {
                ...
                await fetchApi(`/api/company/${elementEdit?.id}`, {
                    method: "PUT",
                    body: form,
                });
                dispacth(
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("obr_username") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("obr_password") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_type") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_TIN") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_phone_number") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_address_province") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_address_commune") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_address_quartier") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_address_avenue") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_address_rue") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_address_number") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_fiscal_center") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100 is-invalid ${hasError("tp_activity_sector") ? "p-invalid" : ""
                                            }`}
                                    />
                                    <div
                                        className="invalid-feedback"
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm col-md-12">
                                    <InputText
                                        ...
                                        onChange={handleChange}
                                        onBlur={checkFieldData}
                                        className={`w-100  is-invalid ${hasError("tp_legal_form") ? "p-invalid" : ""
                                            }`}
                                        style={{ height: 45 }}
                                    />
                                    <div
