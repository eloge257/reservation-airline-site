...
import AddEmployePages from "./AddEmployePages";
import axios from "axios";
import API_URL from "../../../constants/API_URL";
import EditEmployePages from "./EditEmployePages";

// import AddSalleModal from "./AddSalleModal";
// import EditSalleModal from "./EditSalleModal";


export default function ListEmployePages() {
    ...
    const deleteItems = async (itemsIds) => {
        try {
            ...
            await fetchApi(`/api/employee/${itemsIds}`, {
                method: "DELETE",
            });
            dispacth(
                setToastAction({
    ...
    const fetchSalle = useCallback(async () => {
        try {
            ...
            setLoading(true);
            let url = `${API_URL.LOCAL_URL}/api/employee?`;
    ...
    return (
        <>
            ...
            <AddEmployePages setVisible={setVisible} visible={visible} fetchSalle={fetchSalle} />
            {/* ********modal pour editer un elemnt ******** */}
            <EditEmployePages setElementEdit={setElementEdit} elementEdit={elementEdit} setVisibleModal={setVisibleModal} visibleModal={visibleModal} fetchSalle={fetchSalle} />
        </>
    );
}